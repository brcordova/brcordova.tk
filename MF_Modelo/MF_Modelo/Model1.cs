namespace MF_Modelo
{
    ...
    public partial class Model1 : DbContext
    {
        ...
        public virtual DbSet<CLABE> CLABE { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Banco>()
                .Property(e => e.Banco_Dsc)
                .IsUnicode(false);

            modelBuilder.Entity<Banco>()
                .Property(e => e.Banco_Dsc_Corta)
                .IsUnicode(false);

            modelBuilder.Entity<Banco>()
                .Property(e => e.Banco_Clave_Financiera)
                .IsUnicode(false);

            modelBuilder.Entity<Banco>()
                .Property(e => e.Banco_Cuenta_Contable)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<CLABE>()
                .Property(e => e.id_CLABE)
                .HasPrecision(18, 0);

            modelBuilder.Entity<CLABE>()
                .Property(e => e.Contrato_Id)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<Cuenta_Abono>()
                .HasMany(e => e.Cuenta_Abono_Respuesta)
                .WithOptional(e => e.Cuenta_Abono)
                .HasForeignKey(e => e.Cuenta_Abono_Respuesta_clave);
